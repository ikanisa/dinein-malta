-- Migration Function to apply production hardening
-- This can be executed via Supabase REST API rpc endpoint
-- Or via SQL Editor
...
BEGIN
  ...
  RAISE NOTICE 'Production migrations applied successfully';
END;
$$;

-- Execute the function
SELECT public.apply_production_migrations();

-- Clean up the function (optional - you can keep it for future use)
-- DROP FUNCTION IF EXISTS public.apply_production_migrations();
