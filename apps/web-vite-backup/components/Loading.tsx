...
// Base skeleton with variant support
...
export const Skeleton = ({ className = "", variant = 'text', style }: SkeletonProps) => {
  ...
  return (
    <div
      className={clsx(
        'bg-gray-200 dark:bg-white/10 animate-pulse',
...
// Menu Item Skeleton - single item
export const MenuItemSkeleton = () => (
  <GlassCard className="flex gap-4 p-3 bg-surface border-0 shadow-sm">
    <Skeleton className="w-28 h-28 rounded-lg flex-shrink-0" variant="rectangular" />
    <div className="flex-1 space-y-3 py-1 flex flex-col justify-between">
      <div>
...
// Order Card Skeleton - for vendor dashboard
export const OrderCardSkeleton = () => (
  <GlassCard className="p-4 bg-surface border-border">
...
// Vendor Card Skeleton - for admin dashboard
