        ...
        <div className="z-10 flex-1 flex flex-col justify-end pb-12 w-full max-w-md mx-auto animate-slide-up">
            ...
            <GlassCard className="p-2 bg-glass border-glassBorder backdrop-blur-xl shadow-2xl">
                <form onSubmit={handleLogin} className="p-4 space-y-4">
                    <div>
                        <label className="text-xs text-muted uppercase font-bold tracking-wider mb-2 block">Email</label>
                        <input 
                            type="email" 
                            required
                            value={email}
                    ...
                    <div>
                        <label className="text-xs text-muted uppercase font-bold tracking-wider mb-2 block">Password</label>
                        <input 
                            type="password" 
                            required
                            value={password}
