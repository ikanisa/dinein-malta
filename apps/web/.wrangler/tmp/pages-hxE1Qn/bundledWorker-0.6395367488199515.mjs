...
var ce = /* @__PURE__ */ __name((e, t, n, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let a of ae(t)) !ie.call(e, a) && a !== n && V(e, a, { get: /* @__PURE__ */ __name(() => t[a], "get"), enumerable: !(s = re(t, a)) || s.enumerable });
  return e;
}, "ce");
var $ = /* @__PURE__ */ __name((e, t, n) => (n = e != null ? ne(oe(e)) : {}, ce(t || !e || !e.__esModule ? V(n, "default", { value: e, enumerable: true }) : n, e)), "$");
var g;
var u = E(() => {
  g = { collectedLocales: [] };
});
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.6395367488199515.mjs.map
