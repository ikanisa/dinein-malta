...
ThemeData lightTheme() {
  const palette = DineInColors.brightBistro; // Or Candlelight "Light Mode" equivalent if we had one defined
  ...
  return ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle: DineInTypography.textTheme(palette.text0, palette.text1).displaySmall,
