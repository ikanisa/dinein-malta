...
export function SettingsScreen({ selectedCountry, onCountryChange }: SettingsScreenProps) {
    const user = {
        name: 'John Doe',
        ...
        <div className="min-h-screen bg-slate-50/50 pb-28 animate-fade-in text-slate-900">
            ...
            <div className="px-5 pt-6 space-y-8">
                ...
                <GlassCard className="p-4 flex items-center gap-4 shadow-sm border border-indigo-100/50" gradient="indigo">
                    ...
                    <Button variant="ghost" size="md" uniform className="bg-white/50">
                ...
                {/* Logout */}
                <Button variant="solid" color="primary" className="w-full justify-center gap-2" size="lg">
